...
class TransparentFlutterDialogFragment : DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(options: FlutterBoostRouteOptions): TransparentFlutterDialogFragment {
            val fragment = TransparentFlutterDialogFragment()
            fragment.options = options
            return fragment
        }
    }

    lateinit var options: FlutterBoostRouteOptions
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (existing == null) {
            val flutterFragment = FlutterBoostFragment.CachedEngineFragmentBuilder(FlutterBoostFragment::class.java)
