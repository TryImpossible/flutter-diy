...
import 'package:analyzer_exploration/src/command_runner.dart';
...
void main() {
  group('AnalyzerExplorationCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late AnalyzerExplorationCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = AnalyzerExplorationCommandRunner(
        logger: logger,
    ...
    test(
      ...
      () {
        final commandRunner = AnalyzerExplorationCommandRunner();
