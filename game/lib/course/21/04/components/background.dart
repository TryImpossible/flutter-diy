...
class Background extends ParallaxComponent<OwnGame> {
  ...
  Future<List<ParallaxLayer>> fromLayerByMap(Map<String, double> data) async {
    ...
    for (String image in data.keys) {
      ParallaxLayer layer = await game.loadParallaxLayer(
    ...
    final ParallaxLayer airplaneLayer = await game.loadParallaxLayer(
