...
class ParticlesExample extends FlameGame {
  ...
  Future<void> onLoad() async {
    ...
    if (debugMode) {
      add(FpsTextComponent(position: Vector2(10, 45)));
    }
  }
  ...
  Particle smallWhiteCircle() {
    return CircleParticle(radius: 5.0, paint: Paint()..color = Colors.white);
  }
    ...
    return ComputedParticle(
      ...
      renderer: (canvas, particle) {
        ...
        canvas.drawCircle(
          ...
          Paint()
            ..color = Color.lerp(Colors.red, Colors.blue, steppedProgress)!,
        );
      },
    );
  }
  ...
  Particle paintParticle() {
    ...
    final positions = [Vector2(-10, 10), Vector2(10, 10), Vector2(0, -14)];
...
class TrafficLightComponent extends Component {
  ...
  final colors = <Color>[Colors.green, Colors.orange, Colors.red];
