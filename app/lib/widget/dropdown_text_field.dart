...
class DropdownTextFieldController {
  DropdownTextFieldController({this.initialValue});

  final String? initialValue;

  _DropdownTextFieldState? _state;

  void _bindState(_DropdownTextFieldState state) {
...
class DropdownTextField extends StatefulWidget {
  ...
  final DropdownTextFieldController? controller;
