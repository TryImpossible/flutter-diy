...
/// [AppRefreshIndicator] far enough to demonstrate that they want the app to
/// refresh. The returned [Future] must complete when the refresh operation is
/// finished.
///
/// Used by [AppRefreshIndicator.onRefresh].
...
/// Used to configure how [AppRefreshIndicator] can be triggered.
...
///
/// The trigger mode is configured by [AppRefreshIndicator.triggerMode].
///
/// {@tool dartpad}
/// This example shows how [AppRefreshIndicator] can be triggered in different ways.
///
...
///
/// The [AppRefreshIndicator] will appear if its scrollable descendant can be
/// overscrolled, i.e. if the scrollable's content is bigger than its viewport.
/// To ensure that the [AppRefreshIndicator] will always appear, even if the
...
/// ```
///
/// A [AppRefreshIndicator] can only be used with a vertical scroll view.
///
/// See also:
///
///  * <https://material.io/design/platform-guidance/android-swipe-to-refresh.html>
///  * [AppRefreshIndicatorState], can be used to programmatically show the refresh indicator.
///  * [RefreshProgressIndicator], widget used by [AppRefreshIndicator] to show
...
class AppRefreshIndicator extends StatefulWidget {
  ...
  /// Defines how this [AppRefreshIndicator] can be triggered when users overscroll.
  ///
  /// The [AppRefreshIndicator] can be pulled out in two cases,
...
class AppRefreshIndicatorState extends State<AppRefreshIndicator>
  ...
  void initState() {
    ...
    _positionController.addListener(() {
      setState(() {
        _childOffset = _positionController.value;
      });
    });
  }
  ...
  ///
  /// Creating the [AppRefreshIndicator] with a [GlobalKey<RefreshIndicatorState>]
  /// makes it possible to refer to the [AppRefreshIndicatorState].
  ///
  /// The future returned from this method completes when the
  /// [AppRefreshIndicator.onRefresh] callback's future completes.
  ///
    ...
    return Stack(
      children: <Widget>[
        ...
        Padding(
          padding: _mode == null
              ? EdgeInsets.zero
              : EdgeInsets.only(top: widget.displacement * 3 * _childOffset),
          child: child,
        ),
      ],
    );
