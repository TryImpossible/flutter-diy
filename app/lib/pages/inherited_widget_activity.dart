...
class InheritedWidgetActivity extends StatefulWidget {
  const InheritedWidgetActivity({Key? key}) : super(key: key);

  @override
  _InheritedWidgetActivityState createState() =>
      _InheritedWidgetActivityState();
}

class _InheritedWidgetActivityState extends State<InheritedWidgetActivity> {
  int _count = 0;
